...
#Asymmetry Index level analysis: 
...
qplot(x=Var1, y=Var2, data=melt(cor_matrix), fill=value, geom="tile")
...
qplot(x=Var1, y=Var2, data=melt(cor_matrix), fill=value, geom="tile")+ scale_fill_gradient(low="green", high="red")
...
#Look at CARRS clinical measures: 
...
keeps <- c(
    "AlphaDesync_LeftHemi_LeftTarget",   "AlphaDesync_LeftHemi_RightTarget",  "AlphaDesync_RightHemi_LeftTarget", 
    "AlphaDesync_RightHemi_RightTarget", "CPPonset_LeftTarget",               "CPPonset_RightTarget",              "N2c_latency_LeftTarget",            "N2c_latency_RightTarget",           "N2i_latency_LeftTarget",           
    "N2i_latency_RightTarget",           "CPPslope_LeftTarget",               "CPPslope_RightTarget",              "ADHD_Control",                     
    "N2c_LeftTarget_PA",                 "N2c_RightTarget_PA",                "N2i_LeftTarget_PA",                 "N2i_RightTarget_PA",                                          
    "Gender",                            "Age_B",                             "Hand_SR_B",                         "HQ_B",                                      
    "eFSIQ_B",                           "Vocab_Raw_B",                       "Vocab_Scaled_B",                    "Read_Raw_B",                       
    "Read_Standard_B",                   "Spell_Raw_B",                       "Spell_Standard_B",                  "AQ_Tot_B",                          "AQ_Tot_Clin_B",                    
    "AQ_Com_B",                          "AQ_Att_Det_B",                      "AQ_Soc_B",                          "AQ_Imag_B",                         "AQ_Att_Sw_B",         
    "CPRS_A_B",                          "CPRS_B_B",                          "CPRS_C_B",                          "CPRS_D_B",                         
    "CPRS_E_B",                          "CPRS_F_B",                          "CPRS_G_B",                          "CPRS_H_B",                          "CPRS_I_B",                          "CPRS_J_B",                         
    "CPRS_K_B",                          "CPRS_L_B",                          "CPRS_M_B",                          "CPRS_N_B",          
    "Accuracy_LeftTargets",              "Accuracy_RightTargets",             "Accuracy_asym",                     "RT_Left",                           "RT_Right",                          "RTasym",                            "PreAlpha_Asym", "N2c_GA_Asym",                       "N2c_PA_Asym",                       "N2i_GA_Asym",                       "N2i_PA_Asym",                       "N2c_latency_Asym",                  "N2i_latency_Asym",                  "Contra_AlphaDesync_Asym",           "Ipsi_AlphaDesync_Asym",             "CPPonset_Asym",                     "CPPslope_Asym")
data2<-data2[keeps]



#OR try keeping a smaller subset of data
keeps <- c(
    "CPPonset_LeftTarget",               "CPPonset_RightTarget",              "N2c_latency_LeftTarget",            "N2c_latency_RightTarget",           "N2i_latency_LeftTarget",           
    "N2i_latency_RightTarget",           "CPPslope_LeftTarget",               "CPPslope_RightTarget",              "ADHD_Control",                     
    "N2c_LeftTarget_PA",                 "N2c_RightTarget_PA",                "N2i_LeftTarget_PA",                 "N2i_RightTarget_PA",                                          
    "Gender",                            "Age_B",                             "Hand_SR_B",                         "HQ_B",                                      
    "eFSIQ_B",                           "Vocab_Raw_B",                       "Vocab_Scaled_B",                    "Read_Raw_B",                       
    ...
    "CPRS_E_B",                          "CPRS_F_B",                          "CPRS_G_B",                          "CPRS_H_B",                          "CPRS_I_B",                          "CPRS_J_B",                         
    "CPRS_K_B",                          "CPRS_L_B",                          "CPRS_M_B",                          "CPRS_N_B",          
    "Accuracy_LeftTargets",              "Accuracy_RightTargets",             "Accuracy_asym",                     "RT_Left",                           "RT_Right",                          "RTasym")
data2<-data2[keeps]
...
#Only keep relationships that have r value greater than the uncorrected r critical value
cor_data<-cor_data[abs(cor_data$value)>critical.r(n=dim(data2)[1], alpha = .05),]
qplot(x=Var1, y=Var2, data=cor_data, fill=value, geom="tile")+ theme(axis.text.x=element_text(angle=-90))


#Try graphing the absolute r value (rather than +/-)
cor_data$value<-abs(cor_data$value)
qplot(x=Var1, y=Var2, data=cor_data, fill=value, geom="tile")+ theme(axis.text.x=element_text(angle=-90))
...
#Participant level Post-target alpha desync analysis
```{r, message=FALSE}
